...
export default function QuoteSection() {
  return (
    <section className="py-28 md:py-28 bg-primary text-background overflow-hidden relative my-12 md:my-20 grid grid-cols-1 md:grid-cols-[2fr_1fr]">
      ...
      <div className="relative min-h-75 md:min-h-full order-first md:order-last">
        <img
          src="/quote-bg.PNG"
